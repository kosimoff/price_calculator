...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      activeColor: '#2c5282',
      passiveColor: '#2b6cb0',
      glassFinish: 'Прозрачное',
      glassFinishPriceList: {
        'Прозрачное': 0,
        'Матовое': 7,
        'Рисунок': 15
      },
      glassFinishPrice: null,
      glassThickness: '8мм',
      glassThicknessPriceList: {
        '8мм': 32,
        '10мм': 39
      },
      glassThicknessPrice: null,
      accessoriesFinish: 'Серебро',
      accessoriesFinishPriceList: {
        'Серебро': 0,
        'Золото': 50,
        'Чёрное': 50
      },
      accessoriesFinishPrice: null,
      type: 'Простое',
      typePrice: null,
      profileQuantity: 0,
      profilePrice: 15,
      ...
      border: 0,
      paintBorder: false,
      paintBorderPrice: null,
      thirdHinge: false,
      thirdHingePrice: null,
      height: 200,
      length: 120,
      width: 90,
      door: 60,
  ...
  methods: {
    getArea: function getArea() {
      switch (this.shape) {
        case 'Прямая':
          this.perimeter = this.length / 100;
          this.area = this.perimeter * this.height / 100;
          break;

        case 'Угловая':
          this.perimeter = this.length / 100 + this.width / 100;
          this.area = this.perimeter * this.height / 100;
          break;
    ...
    calculate: function calculate() {
      if (this.shape != 'Вручную') {
        ...
        this.perimeter = (this.perimeter * 1).toFixed(2);
      }

      if (this.type === 'Профильное') {
        this.typePrice = 50;
        this.accessoriesFinishPrice = 0;
        this.profileQuantity = 0;
        ...
        if (this.borderType === 'Узкая') {
          this.borderType = 'Без бардюра';
        }
      }

      if (this.type === 'Простое') {
        this.typePrice = 0;
        this.accessoriesFinishPrice = this.accessoriesFinishPriceList[this.accessoriesFinish];
      }

      this.glassThicknessPrice = this.glassThicknessPriceList[this.glassThickness] * this.area;
      this.glassFinishPrice = this.glassFinishPriceList[this.glassFinish] * this.area;
      this.fixer = this.fixerPrice * this.fixerQuantity;
      this.profile = this.profilePrice * this.profileQuantity;
      this.border = this.borderPrice[this.borderType] * this.perimeter;

      if (this.borderType != 'Без бардюра' && this.paintBorder) {
        this.paintBorderPrice = 20;
      } else {
        this.paintBorderPrice = 0;
      }

      if (this.type === 'Простое' && this.thirdHinge) {
      ...
      if (this.area > 1.2 && this.area <= 1.6) {
        this.squareMeterPrice = 129;
      }

      if (this.area > 1.6 && this.area <= 1.7) {
        this.squareMeterPrice = 128;
      }

      if (this.area > 1.7 && this.area <= 1.8) {
        this.squareMeterPrice = 127;
      }

      if (this.area > 1.8 && this.area <= 1.9) {
        this.squareMeterPrice = 125;
      }

      if (this.area > 1.9 && this.area <= 2) {
        this.squareMeterPrice = 123;
      }

      if (this.area > 2 && this.area <= 2.1) {
        this.squareMeterPrice = 121;
      }

      if (this.area > 2.1 && this.area <= 2.2) {
        this.squareMeterPrice = 119;
      }

      if (this.area > 2.2 && this.area <= 2.3) {
        this.squareMeterPrice = 117;
      }

      if (this.area > 2.3 && this.area <= 2.4) {
        this.squareMeterPrice = 115;
      }

      if (this.area > 2.4 && this.area <= 2.5) {
        this.squareMeterPrice = 113;
      }

      if (this.area > 2.5 && this.area <= 2.6) {
        this.squareMeterPrice = 111;
      }

      if (this.area > 2.6 && this.area <= 2.7) {
        this.squareMeterPrice = 110;
      }

      if (this.area > 2.7 && this.area <= 2.8) {
        this.squareMeterPrice = 109;
      }

      if (this.area > 2.8 && this.area <= 2.9) {
        this.squareMeterPrice = 108;
      }

      if (this.area > 2.9 && this.area <= 3) {
        this.squareMeterPrice = 107;
      }

      if (this.area > 3 && this.area <= 3.1) {
        this.squareMeterPrice = 106;
      }

      if (this.area > 3.1 && this.area <= 3.2) {
        this.squareMeterPrice = 105;
      }

      if (this.area > 3.2 && this.area <= 3.3) {
        this.squareMeterPrice = 104;
      }

      if (this.area > 3.3 && this.area <= 3.4) {
        this.squareMeterPrice = 103;
      }

      if (this.area > 3.4 && this.area <= 3.5) {
        this.squareMeterPrice = 102;
      }

      if (this.area > 3.5 && this.area <= 3.6) {
        this.squareMeterPrice = 101;
      }
      ...
      this.subTotal = this.typePrice + this.accessoriesFinishPrice + this.glassThicknessPrice + this.glassFinishPrice + this.fixer + this.profile + this.border + this.paintBorderPrice + this.thirdHingePrice;
      this.totalFormula = this.formula * 1 + this.subTotal;
      this.totalSquareMeter = this.squareMeterPrice * this.area + this.subTotal - this.glassThicknessPriceList['8мм'] * this.area;
    }
  }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "ml-10" }, [
    !_vm.result
      ? _c("div", {}, [
          _c("h1", [_vm._v("Калькулятор цены")]),
          _vm._v(" "),
          _c("div", { staticClass: "mt-2" }, [
            _c(
              "button",
              {
                ...
                style: {
                  backgroundColor:
                    _vm.type === "Простое" ? _vm.activeColor : _vm.passiveColor
                },
                attrs: { type: "button", name: "button" },
                on: {
                  click: function($event) {
                    ;(_vm.type = "Простое"), _vm.calculate()
                  }
                }
              },
              [_vm._v("Простое")]
            ...
            _c(
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    ;(_vm.type = "Профильное"), _vm.calculate()
                  }
                }
              },
              [_vm._v("Профильное")]
          ...
          _c("div", { staticClass: "mt-2" }, [
            ...
            _c(
              "button",
              {
                ...
                style: {
                  backgroundColor:
                    _vm.shape === "Прямая" ? _vm.activeColor : _vm.passiveColor
                },
                attrs: { type: "button", name: "button" },
                on: {
                  click: function($event) {
                    ;(_vm.shape = "Прямая"), _vm.calculate()
                  }
                }
              },
              [_vm._v("Прямая")]
            ...
            _c(
              "button",
              {
                ...
                style: {
                  backgroundColor:
                    _vm.shape === "Угловая" ? _vm.activeColor : _vm.passiveColor
                },
                attrs: { type: "button", name: "button" },
                on: {
                  click: function($event) {
                    ;(_vm.shape = "Угловая"), _vm.calculate()
                  }
                }
              },
              [_vm._v("Угловая")]
                ...
                _c("input", {
                  ...
                  on: {
                    ...
                    input: function($event) {
                      ...
                      _vm.perimeter = $event.target.value
                    }
                  }
                }),
                _vm._v(" м\n    ")
            ...
            ? _c("div", { staticClass: "mt-2" }, [
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        ;(_vm.accessoriesFinish = "Серебро"), _vm.calculate()
                      }
                    }
                  },
                  [_vm._v("Серебро")]
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        ;(_vm.accessoriesFinish = "Золото"), _vm.calculate()
                      }
                    }
                  },
                  [_vm._v("Золото")]
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        ;(_vm.accessoriesFinish = "Чёрное"), _vm.calculate()
                      }
                    }
                  },
                  [_vm._v("Чёрное")]
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.thirdHinge,
                      expression: "thirdHinge"
                    }
                  ],
                  attrs: { type: "checkbox" },
                  domProps: {
                    checked: Array.isArray(_vm.thirdHinge)
                      ? _vm._i(_vm.thirdHinge, null) > -1
                      : _vm.thirdHinge
                  },
                  on: {
                    change: [
                      function($event) {
                        var $$a = _vm.thirdHinge,
                          $$el = $event.target,
          ...
          _c("div", { staticClass: "mt-2" }, [
            ...
            _vm.type === "Простое"
              ? _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        ;(_vm.borderType = "Узкий"), _vm.calculate()
                      }
                    }
                  },
                  [_vm._v("Узкий")]
            ...
            _c(
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    ;(_vm.borderType = "Широкий"), _vm.calculate()
                  }
                }
              },
              [_vm._v("Широкий")]
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.paintBorder,
                      expression: "paintBorder"
                    }
                  ],
                  attrs: { type: "checkbox" },
                  domProps: {
                    checked: Array.isArray(_vm.paintBorder)
                      ? _vm._i(_vm.paintBorder, null) > -1
                      : _vm.paintBorder
                  },
                  on: {
                    change: [
                      function($event) {
                        var $$a = _vm.paintBorder,
                          $$el = $event.target,
                          $$c = $$el.checked ? true : false
                        if (Array.isArray($$a)) {
                          var $$v = null,
                            $$i = _vm._i($$a, $$v)
                          if ($$el.checked) {
                            $$i < 0 && (_vm.paintBorder = $$a.concat([$$v]))
                          } else {
                            $$i > -1 &&
                              (_vm.paintBorder = $$a
                                .slice(0, $$i)
          ...
          _vm.type === "Простое"
            ? _c("div", { staticClass: "mt-2" }, [
                _c("label", { attrs: { for: "" } }, [_vm._v("Профиль:")]),
                _c("br"),
                _vm._v(" "),
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        _vm.profileQuantity != 0 ? _vm.profileQuantity-- : "",
                          _vm.calculate()
                      }
                    }
                  },
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        _vm.profileQuantity++, _vm.calculate()
                      }
                    }
                  },
                  [_vm._v("+")]
          ...
          _vm.type === "Простое"
            ? _c("div", { staticClass: "mt-2" }, [
                _c("label", { attrs: { for: "" } }, [_vm._v("Крепление:")]),
                _c("br"),
                _vm._v(" "),
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        _vm.fixerQuantity != 0 ? _vm.fixerQuantity-- : "",
                          _vm.calculate()
                      }
                    }
                  },
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        _vm.fixerQuantity++, _vm.calculate()
                      }
                    }
                  },
                  [_vm._v("+")]
          ...
          _c("div", { staticClass: "mt-2" }, [
            _c(
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    ;(_vm.glassFinish = "Прозрачное"), _vm.calculate()
                  }
                }
              },
              [_vm._v("Прозрачное")]
            ...
            _c(
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    ;(_vm.glassFinish = "Матовое"), _vm.calculate()
                  }
                }
              },
              [_vm._v("Матовое")]
            ...
            _c(
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    ;(_vm.glassFinish = "Рисунок"), _vm.calculate()
                  }
                }
              },
              [_vm._v("Рисунок")]
            ...
            ? _c("div", { staticClass: "mt-2" }, [
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        ;(_vm.glassThickness = "8мм"), _vm.calculate()
                      }
                    }
                  },
                  [_vm._v("8мм")]
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        ;(_vm.glassThickness = "10мм"), _vm.calculate()
                      }
                    }
                  },
                  [_vm._v("10мм")]
          ...
          _c(
            ...
            {
              staticClass:
                "py-1 px-2 mt-2 bg-red-800 hover:bg-red-900 rounded-lg focus:outline-none text-white",
              attrs: { type: "button", name: "button" },
              on: {
                click: function($event) {
                  ;(_vm.result = true), _vm.calculate()
                }
              }
            },
            [_vm._v("Подсчитать")]
    ...
    _vm.result
      ? _c("div", {}, [
            ...
            _c("input", {
              ...
              on: {
                ...
                input: function($event) {
                  ...
                  _vm.exchangeRate = $event.target.value
                }
              }
            })
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "mt-2" }, [
            _c("label", { attrs: { for: "formula" } }, [_vm._v("Формула: ")]),
            _c("input", {
              directives: [
                {
                  name: "model",
          ...
          _c("div", {}, [
            ...
            _vm.type === "Простое" && _vm.accessoriesFinish != "Серебро"
              ? _c("p", [
                  _vm._v(
                    _vm._s(_vm.accessoriesFinish) +
                      ": " +
                      _vm._s(_vm.accessoriesFinishPrice) +
                      "$"
                  )
                ])
              : _vm._e(),
            _vm._v(" "),
            _vm.thirdHingePrice > 0
              ? _c("p", [
                  _vm._v(
                    "Дополнительная петля: " + _vm._s(_vm.thirdHingePrice) + "$"
                  )
                ])
              : _vm._e(),
            _vm._v(" "),
            ...
            _vm.glassFinish != "Прозрачное"
              ? _c("p", [
                  _vm._v(
                    _vm._s(_vm.glassFinish) +
                      ": " +
                      _vm._s(_vm.glassFinishPriceList[this.glassFinish]) +
                      "$ * " +
                      _vm._s((_vm.area * 1).toFixed(2)) +
                      "м² = " +
                      _vm._s(_vm.glassFinishPrice.toFixed(2)) +
                      "$"
                  )
                ])
              : _vm._e(),
            _vm._v(" "),
            _vm.type === "Простое" && _vm.profileQuantity > 0
              ? _c("p", [
                  _vm._v(
                    "Профиль: " +
                      _vm._s(_vm.profilePrice) +
                      "$ x " +
                      _vm._s(_vm.profileQuantity) +
                      " шт. = " +
                      _vm._s(_vm.profile) +
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.type === "Простое" && _vm.fixerQuantity > 0
              ? _c("p", [
                  _vm._v(
                    "Крепление: " +
                      _vm._s(_vm.fixerPrice) +
                      "$ x " +
                      _vm._s(_vm.fixerQuantity) +
                      " шт. = " +
                      _vm._s(_vm.fixer) +
            ...
            _vm.borderType != "Без бардюра"
              ? _c("p", [
                  _vm._v(
                    "Бардюр (" +
                      _vm._s(_vm.borderType.toLowerCase()) +
                      "): " +
                      _vm._s(_vm.borderPrice[_vm.borderType]) +
                      "$ x " +
                      _vm._s((_vm.perimeter * 1).toFixed(2)) +
                      " м = " +
                      _vm._s(_vm.border.toFixed(2)) +
                      "$"
                  )
                ])
              : _vm._e(),
            _vm._v(" "),
            _vm.borderType != "Без бардюра" && _vm.paintBorder
              ? _c("p", [
                  _vm._v(
                    "Покраска бардюра: " + _vm._s(_vm.paintBorderPrice) + "$"
                  )
                ])
              : _vm._e(),
            _vm._v(" "),
            ...
            _c("p", [
              ...
              _vm._v(
                " " +
                  ...
                  "$ (" +
                  _vm._s((_vm.totalSquareMeter / _vm.area).toFixed(0)) +
                  "$/м²)"
              )
            ]),
            _vm._v(" "),
...
__webpack_require__(/*! /Users/farrukh/Desktop/price_calculator/src/app.js */"./src/app.js");
module.exports = __webpack_require__(/*! /Users/farrukh/Desktop/price_calculator/src/app.scss */"./src/app.scss");
